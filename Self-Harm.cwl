...
steps:
  ...
  self-harm-attempted---primary:
    run: self-harm-attempted---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-selfincineration---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-attempted---primary/output
  ...
  caustic-self-harm---primary:
    run: caustic-self-harm---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-subst---primary:
    run: self-harm-subst---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: caustic-self-harm---primary/output
  domestic-self-harm---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-subst---primary/output
  ...
  antiepileptic-self-harm---primary:
    run: antiepileptic-self-harm---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-suffocation---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: antiepileptic-self-harm---primary/output
  ...
  self-harm-suffc---primary:
    run: self-harm-suffc---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-wrist---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-suffc---primary/output
  ...
  self-harm-alcohol---primary:
    run: self-harm-alcohol---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-inflicted---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-alcohol---primary/output
  ...
  self-harm-front---primary:
    run: self-harm-front---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-selfscalding---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-front---primary/output
  output-cases:
